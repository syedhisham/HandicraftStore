    ...
    const fetchProducts = async () => {
      try {
        const response = await axios.get(
          ...
          {
            params: { subcategory: "Clutches & Wristlets" },
          }
        );
        setProducts(response.data.data.docs); // Assuming paginated response
      } catch (error) {
        console.error("Error fetching Clutches & Wristlets products:", error);
      } finally {
...
export default ClutchesWristlets;
