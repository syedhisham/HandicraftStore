    ...
    const fetchProducts = async () => {
      try {
        const response = await axios.get(
          ...
          {
            params: { subcategory: "Unstitched Fabric" },
          }
        );
        setProducts(response.data.data.docs); // Assuming paginated response
      } catch (error) {
        console.error("Error fetching Unstitched Fabric products:", error);
      } finally {
...
export default UnstitchedFabric;
