    ...
    const fetchProducts = async () => {
      try {
        const response = await axios.get(
          ...
          {
            params: { subcategory: "Sweaters, Coats & Uppers" },
          }
        );
        setProducts(response.data.data.docs); // Assuming paginated response
      } catch (error) {
        console.error("Error fetching Sweaters, Coats & Uppers products:", error);
      } finally {
...
export default SweatersCoatsUppers;
