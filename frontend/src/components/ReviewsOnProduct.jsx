  ...
  const fetchCommentsAndRatings = async (page) => {
    try {
      const response = await axios.get(
        `/api/reviews/product/${productId}/allComments`,
        {
          params: { page, limit: 6 },
        }
      );
      ...
      if (response.status === 200) {
        ...
        const ratingsResponse = await axios.get(
          `/api/reviews/product/${productId}/avgRating`
        );
        ...
        const distributionResponse = await axios.get(
          `/api/reviews/product/${productId}/ratingDistribution`
        );
    ...
    <div className="container mx-auto px-4 py-2">
      ...
      <div className="comment-section border-t border-gray-300 pt-4">
        ...
        <form onSubmit={handleCommentSubmit}>
          ...
          <Button
            type="submit"
            className="bg-orange-500 hover:bg-gray-700 text-white py-2 px-4 rounded-lg transition duration-200"
          >
            Submit
          </Button>
        </form>
