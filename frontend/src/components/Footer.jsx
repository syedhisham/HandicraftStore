...
import Logo from "../assets/CraftedLogo35.png"
...
const SITEMAP = [
  ...
  },
  {
    title: "Resources",
    links: [
      { label: "Craft", path: "/allCategoryProducts" },
      { label: "Decor", path: "/allCategoryProducts" },
  ...
  return (
    ...
    <div className="absolute left-0 top-0 translate-y-10">
      {/* <h1 className="text-white text-2xl font-bold ml-4">CraftedTreasures</h1> */}
        ...
        <div className="flex w-full flex-col items-center justify-center border-t border-orange-200 py-4 md:flex-row md:justify-between">
          <p className="mb-4 text-center font-normal text-white md:mb-0 text-sm">
            &copy; {currentYear} <a href="/">CraftedTreasures</a>. All Rights
            Reserved.
          </p>
